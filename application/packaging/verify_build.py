...
def verify(toc_path: Path, dist_dir: Path) -> dict[str, object]:
    ...
    required_files = (
        ...
        "_internal/PySide6/QtTextToSpeech.pyd",
        ...
        "_internal/PySide6/Qt6TextToSpeech.dll",
        "_internal/PySide6/plugins/texttospeech/qtexttospeech_sapi.dll",
    ...
    required_modules = {
        ...
        "ollama_chat_app.services.life_agent",
        "ollama_chat_app.services.agent_tools",
        "ollama_chat_app.services.device_observations",
        "ollama_chat_app.providers.demo_life",
