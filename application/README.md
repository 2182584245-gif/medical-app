...
本版把 GitHub 协作者 `9914ace` 的桌面生活智能体改进合并到已交付的本地
1.5.0 基础，不回退离线缓存、阿里云同步、医疗/环境记录、分段时间与账号隔离。
运行方式仍为下载根目录唯一的 **1.6.0 电脑版演示版 ZIP**，完整解压后启动 EXE；
...
发布范围、兼容性与验证边界见 [1.6.0 发布说明](docs/release-1.6.0.md)。
